describe("Media", function() {
  ...
  it("should return comparison array", function() {
    ...
    expect(result[0]["name"]).toEqual("Year");
    expect(result[0]["first"]).toEqual(1980);
    expect(result[0]["second"]).toBe(undefined);
    expect(result[2]["name"]).toEqual("Director");
    expect(result[2]["first"]).toEqual("Irvin Kershner");
    expect(result[2]["second"]).toEqual(undefined);
    ...
    expect(result[0]["name"]).toEqual("Year");
    expect(result[0]["first"]).toEqual(1980);
    expect(result[0]["second"]).toEqual(1983);
    expect(result[2]["name"]).toEqual("Director");
    expect(result[2]["first"]).toEqual("Irvin Kershner");
    expect(result[2]["second"]).toEqual("Richard Marquand");
  });
});
